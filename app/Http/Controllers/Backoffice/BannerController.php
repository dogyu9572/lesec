...
class BannerController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'use_period' => 'boolean',
            'is_active' => 'boolean',
            'desktop_image' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2097152',
            'mobile_image' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2097152',
            'video_url' => 'nullable|url',
            'sort_order' => 'nullable|integer|min:0',
        ], [
            'desktop_image.max' => '이미지 용량이 2GB를 초과합니다. 더 작은 이미지를 선택해주세요.',
            'desktop_image.image' => '이미지 파일만 업로드 가능합니다.',
            'desktop_image.mimes' => 'JPG, PNG, GIF 파일만 업로드 가능합니다.',
            'mobile_image.max' => '이미지 용량이 2GB를 초과합니다. 더 작은 이미지를 선택해주세요.',
