...
class AdultMemberRegistrationRequest extends FormRequest
{
    /**
     * 권한을 확인합니다.
     */
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            ...
            'student_contact' => preg_replace('/\s+/', '', (string) $this->input('student_contact')),
            'parent_contact' => preg_replace('/\s+/', '', (string) $this->input('parent_contact')),
            'email' => $email,
        ]);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'class_number' => ['nullable', 'integer', 'min:1', 'max:30'],
    ...
    public function messages(): array
    {
        return [
            ...
            'student_contact.required' => '학생 연락처를 입력해 주세요.',
            'student_contact.max' => '학생 연락처는 20자 이하로 입력해 주세요.',
            'parent_contact.required' => '보호자 연락처를 입력해 주세요.',
            'parent_contact.max' => '보호자 연락처는 20자 이하로 입력해 주세요.',
            ...
            'grade.integer' => '학년은 숫자로 선택해 주세요.',
            'grade.min' => '학년은 1 이상이어야 합니다.',
            'grade.max' => '학년은 12 이하로 입력해 주세요.',
            'class_number.integer' => '반 정보는 숫자로 선택해 주세요.',
            'class_number.min' => '반 정보는 1 이상이어야 합니다.',
            'class_number.max' => '반 정보는 30 이하로 입력해 주세요.',
