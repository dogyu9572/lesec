    ...
    public function run(): void
    {
        $programs = [
            [
                ...
                'education_start_date' => Carbon::now()->addDays(5)->format('Y-m-d'),
                'education_end_date' => Carbon::now()->addDays(5)->format('Y-m-d'),
                'payment_methods' => ['bank_transfer', 'online_card'],
                'reception_type' => 'application',
                'application_start_date' => Carbon::now()->subDays(7)->format('Y-m-d'),
            ...
            [
                'education_type' => 'middle_semester',
                'application_type' => 'group',
                'program_name' => 'M2. DNA 추출(단체만 신청 가능)',
                'education_start_date' => Carbon::now()->addDays(5)->format('Y-m-d'),
                'education_end_date' => Carbon::now()->addDays(5)->format('Y-m-d'),
                'payment_methods' => ['bank_transfer', 'online_card'],
                'reception_type' => 'application',
            ...
            [
                'education_type' => 'middle_semester',
                'application_type' => 'group',
                'program_name' => 'M3. 분류학으로 보는 생물의 세계',
                'education_start_date' => Carbon::now()->addDays(5)->format('Y-m-d'),
                'education_end_date' => Carbon::now()->addDays(5)->format('Y-m-d'),
                'payment_methods' => ['bank_transfer', 'online_card'],
                'reception_type' => 'application',
