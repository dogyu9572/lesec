...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (modal) {
        programSearchUrl = modal.dataset.programSearchUrl || '/backoffice/individual-programs/search-programs';
        directInputTargetInputId = modal.dataset.programInputId || 'program_name';
    } else {
        programSearchUrl = '/backoffice/individual-programs/search-programs';
