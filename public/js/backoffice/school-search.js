...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const memberDistrictInput = document.getElementById("district");
  const memberCityDisplay = document.getElementById("city_display");
  const memberDistrictDisplay = document.getElementById("district_display");
