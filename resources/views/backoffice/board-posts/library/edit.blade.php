...
<div class="board-card-body">
            ...
            <form id="board-post-edit-form" action="{{ route('backoffice.board-posts.update', [$board->slug ?? 'library', $post->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="board-form-actions btns_abso">
                    ...
                    <a href="{{ route('backoffice.board-posts.index', $board->slug ?? 'library') }}" class="btn btn-secondary">취소</a>
                    <form action="{{ route('backoffice.board-posts.destroy', [$board->slug ?? 'library', $post->id]) }}"
