                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid grid-2">
                                ...
                                <div class="form-group teacher-only">
                                    ...
                                    <input type="text" id="contact_teacher" name="contact" value="{{ old('contact') }}">
                                </div>
                            ...
                            <div class="form-grid grid-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="school-search-wrapper">
                                        <input type="text" id="school_name" name="school_name" value="{{ old('school_name') }}" class="school-search-input">
