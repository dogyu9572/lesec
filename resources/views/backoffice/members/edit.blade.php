    ...
    <div class="category-modal-content school-search-modal">
        ...
        <div class="category-modal-body">
            <form id="school-search-form"
                data-url="{{ route('member.schools.search') }}">
                ...
                <div class="modal-form-group">
                    ...
                    <div class="modal-form-inline keyword-inline">
                        ...
                        <button type="submit" class="btn btn-dark btn-search">검색</button>
                    </div>
        ...
        <div class="category-modal-footer">
            ...
            <button type="button" id="school-select-confirm" class="btn btn-dark" disabled>확인</button>
        </div>
    </div>
</div>
