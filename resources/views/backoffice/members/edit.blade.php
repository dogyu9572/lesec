                        ...
                        <div class="program-section">
                            ...
                            <div class="form-grid grid-3">
                                ...
                                <div class="form-group">
                                    <label>이메일</label>
                                    @php
                                        $emailValue = old('email', $member->email);
                        ...
                        <div class="program-section">
                            ...
                            <div class="form-grid grid-2">
                                <div class="form-group">
                                    <label>지역</label>
                                    @php
                                        $cityValue = old('city', $member->city);
                                        $districtValue = old('district', $member->district);
                                    ...
                                    <input type="hidden" id="city" name="city" value="{{ old('city', $member->city) }}">
                                    <input type="hidden" id="district" name="district" value="{{ old('district', $member->district) }}">
                                </div>
