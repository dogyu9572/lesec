	...
	<div class="inner">
		<div class="mem_wrap join_wrap">
			...
			<div class="mem_half years_type">
				<a href="/member/register2_a" class="btn01"><span class="tt">만 14세 미만 회원</span><p>만 14세 미안 회원은 개인정보보호법에 따라 <br/><strong>법정대리인(보호자)의 동의</strong>가 필요합니다.</p></a>
				<a href="/member/register2_b" class="btn02"><span class="tt">만 14세 이상 회원</span><p>만 14세 이상 회원은 <strong>본인 명의의 <br/>휴대전화를 통해</strong> 인증이 진행됩니다.</p></a>
			</div>
		</div>
	</div>
