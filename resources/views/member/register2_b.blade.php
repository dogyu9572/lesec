		...
		<div class="mem_wrap join_wrap">
			...
			<div class="mem_half">
				<div class="phone_certification">
					...
					<p>PASS 앱을 통한 휴대전화 인증으로 보다 간편하고 <br/>안전하게 본인 확인을 진행할 수 있습니다.</p>
					<button type="button" class="btn btn_wkk" onclick="location.href='/member/register3_b'">휴대폰 인증하기</button>
				</div>
