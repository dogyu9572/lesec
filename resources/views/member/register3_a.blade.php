			...
			<form method="POST"
				...
				<div class="inputs">
					...
					<dl>
						...
						<dd>
							<div class="password-wrap password-wrap_add">
								<input type="password" name="password_confirmation" class="text w100p password-input_add" value="{{ old('password_confirmation') }}" placeholder="비밀번호를 다시 입력해주세요." aria-label="비밀번호 확인">
								<button type="button" class="btn-eye toggle-password_add r16" aria-label="비밀번호 보기"><img src="/images/icon_eye.svg" alt="보기"></button>
							</div>
					...
					<dl>
						...
						<dd>
							<input type="text" name="parent_contact" class="w100p" value="{{ old('parent_contact', $verifiedPhoneDisplay) }}" placeholder="휴대폰번호를 입력해주세요." data-phone-input inputmode="tel" autocomplete="tel" aria-label="휴대폰번호" @if(!empty($verifiedPhoneDisplay)) readonly @endif>
