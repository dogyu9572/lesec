	...
	<div class="inner">
		<div class="apply_write" data-program-page="apply" data-apply-mode="group">
			...
			<div class="absoarea">
				...
				<button type="button" class="btn_apply pc_vw" data-navigate-select="group" data-select-url="{{ route('program.select.group', $type) }}">신청하기</button>
			</div>
			...
			<div class="btn_apply_wrap mo_vw">
				<button type="button" class="btn_apply" data-navigate-select="group" data-select-url="{{ route('program.select.group', $type) }}">신청하기</button>
			</div>
		</div>
	</div>
