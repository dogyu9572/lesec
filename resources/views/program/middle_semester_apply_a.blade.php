	...
	<div class="inner">
		<div class="apply_write">
			...
			<div class="absoarea">
				...
				<button type="button" class="btn_apply pc_vw" onclick="location.href='/program/middle_semester_apply_a2'">신청하기</button>
			</div>
			...
			<div class="btn_apply_wrap mo_vw">
				<button type="button" class="btn_apply" onclick="location.href='/program/middle_semester_apply_a2'">신청하기</button>
			</div>
		</div>
	</div>
